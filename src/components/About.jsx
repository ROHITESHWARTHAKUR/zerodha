...
import logo from '../assets/rohit1.jpg';
  ...
  const leaders = [
    {
      name: "Nikhil Kamath",
      role: "Co-founder & CFO",
      img: "https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8dXNlcnxlbnwwfHwwfHx8MA%3D%3D",
    },
    {
        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center mb-16">
            ...
            <div className="text-gray-700 text-sm leading-relaxed">
              <h3 className="text-lg font-semibold mb-1">Rohiteswer Thakur</h3>
